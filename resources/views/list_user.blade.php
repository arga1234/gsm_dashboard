			  ...
			  $(document).ready(function(){
				$("#datatable-editable").DataTable();
					...
					function populateDataTable(data) {
						...
						var action = "<a href='detail_user?id="+data[i]._id+"'>Detail</a>&nbsp&nbsp&nbsp"+"<a href='#' onclick=add_to_assesor('"+data[i]._id+"') data-toggle='modal' data-target='#con-close-modal'>Add To Assesor</a>";
